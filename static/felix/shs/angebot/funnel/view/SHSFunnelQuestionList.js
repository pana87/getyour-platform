const pathToAssets = "/felix/shs/angebot/funnel/view/"

const lastAnswer = `
<div class="plzinputfeld-Fxiv7r"></div>
<div class="plzpruefeninput-Fxiv7r"></div>
<div class="prfen-sie-sofort-ob-Fxiv7r">Prüfen Sie sofort, ob Monteure in Ihrer Nähe verfügbar sind.</div>
<div class="prfen-Fxiv7r">prüfen</div>
<div class="postleitzahl-Fxiv7r">Postleitzahl..</div>
`

export const SHSFunnelQuestionList = [
  ...
  { question: "Wo soll die Photovoltaik-Anlage installiert werden?", answers: [
    { answer: lastAnswer, image: `${pathToAssets}/img/xxx.svg`}
  ]},
]
