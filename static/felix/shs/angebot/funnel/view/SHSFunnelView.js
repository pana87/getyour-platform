...
const COMPONENT_PATHNAME = "/shs/funnel/start/"

export class SHSFunnelView extends HTMLElement {
  ...
  changeQuestion(questionIndex) {
    ...
    const divs = this.shadowRoot.querySelectorAll("div[class*=overlap-group2]")
...
window.customElements.define("getyour-shs-funnel-view", SHSFunnelView)
