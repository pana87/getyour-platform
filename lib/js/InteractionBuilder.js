...
export class InteractionBuilder extends HTMLElement {
  ...
  connectedCallback() {
    ...
    this.shadowRoot.querySelector("div[class*='content']").append(new InteractionBuilderForm())
  ...
  async close() {
    ...
    document.querySelectorAll("interaction-builder").forEach(element => element.remove())
  }
}

window.customElements.define("interaction-builder", InteractionBuilder)
