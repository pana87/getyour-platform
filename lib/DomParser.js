...
const { clientLocation, authLocation, componentsLocation, dbLocation } = require("../config/ServerLocation.js")
const { Helper } = require("./Helper.js")

// const GLOBAL_SCRIPT = `
// <script id="global-js" type="module" src="${clientLocation.origin}/js/global.js"></script>
// </body>
// `
...
module.exports = class DomParser {
  ...
  // withReplace(className, replace) {
  //   this.fileString.replace(//g, )
  // }
  withParagraphField(fieldSelector) {
    this.html.replace()
  }

  constructor(relativePath) {
    this.filePath = path.join(__dirname, relativePath)
    this.html = Helper.readFileSyncToString(relativePath)
  }
