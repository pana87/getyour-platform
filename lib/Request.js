                    ...
                    if (user.id === req.jwt.id) {
                      ...
                      if (Helper.verifyIs("user/getyour-admin", user)) {
                        ...
                        await Helper.sendEmailFromDroid({
                          from: "<droid@get-your.de>",
                          to: req.body.email,
                          subject: `[${req.location.platform}] Einladung`,
                          html: /*html*/`
                            <div>
                              Du wurdest von einem Admin eingeladen, als Experte auf ${req.location.platform} Plattform teilzunehmen. <a href="https://www.get-your.de/pana/getyour/login/">Du kannst dich ab jetzt hier anmelden.</a><br/><br/>
            ...
            if (req.location !== undefined) {
              if (req.jwt !== undefined) {
                ...
                for (let i = 0; i < doc.users.length; i++) {
                  ...
                  if (user.id === req.jwt.id) {
                    if (user.verified === false) throw new Error("jwt user not verified")
                  }
