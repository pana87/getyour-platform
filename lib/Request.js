                    ...
                    if (user.id === req.jwt.id) {
                      ...
                      if (Helper.verifyIs("user/getyour-admin", user)) {
                        ...
                        await Helper.sendEmailFromDroid({
                          ...
                          html: /*html*/`
                            <div>
                              Du wurdest von '${req.body.email}' eingeladen, als Experte auf unserer Plattform teilzunehmen. <a href="https://www.get-your.de/login/">Du kannst dich ab jetzt hier anmelden.</a><br/><br/>
