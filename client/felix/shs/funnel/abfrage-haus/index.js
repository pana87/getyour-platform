...
// const hausdeckmasslaenge = new NumberField("div[class*='hausdeckmasslaenge']").withMin("0").withMax("100").withPlaceholder("in mm")
// const hausdeckmassbreite = new NumberField("div[class*='hausdeckmassbreite']").withMin("0").withMax("100").withPlaceholder("in mm")

// const hauskabel = new SelectionField("div[class*='hauskabel']").withOptions(["Innen", "Außen", "Andere"])
// // const hausenergie = new SelectionField("div[class*='hausenergie']").withOptions(["Nein", "Ja, ich habe schon eine Photovoltaikanlage", "Ja, ich habe schon eine Wärmepumpe", "Ja, ich habe schon eine Solarthermie", "Ja, ich habe schon ein Stromspeicher"])
// const hausuk = new SelectionField("div[class*='hausuk']").withOptions(["Ja", "Nein"])
// const hausgeruest = new SelectionField("div[class*='hausgeruest']").withOptions(["Ja", "Nein"])
